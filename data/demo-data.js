// ============================================================
// נתוני בסיס (דמו/פולבק) לתשואות אג"ח ממשלתיות
// ------------------------------------------------------------
// משמש כפולבק לכל תא שאין לו מקור חי (ראו live-sources.js),
// וכמקור היחיד למדינות שאין להן API חינמי וללא מפתח.
//
// כדי לעדכן ערך דמו: שנו את המספר במערך yields של המדינה
// (תשואה שנתית/אנצואלית, ב-%), לפי הסדר שמוגדר ב-periods.
// ============================================================

module.exports = {
  // תאריך "נכון ל-" של ערכי הדמו (לא רלוונטי לתאים עם נתון חי)
  asOf: "2026-06-15",
